...
+ (NSString *)getUUID{
    if ([[UIDevice currentDevice].systemVersion floatValue] < 5.0) {
        ...
        NSString *uuidData = [[NSUserDefaults standardUserDefaults] objectForKey:@"UUIDDATA"];
        if (uuidData == nil) {
            if([[NSString stringWithFormat:@"%@", CFUUIDCreate(kCFAllocatorSystemDefault)] length]>19){
                UUID = [[NSString stringWithFormat:@"%@", CFUUIDCreate(kCFAllocatorSystemDefault)] substringFromIndex:19];
                UUID=[UUID stringByReplacingOccurrencesOfString:@" " withString:@""];
                [[NSUserDefaults standardUserDefaults] setValue:UUID forKey:@"UUIDDATA"];
